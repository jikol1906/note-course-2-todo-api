...
describe('DELETE /todos/:id', () => {
  ...
  it('should remove a todo', (done) => {
    ...
    it('should not remove todo that belongs to another user', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not update todo that belongs to another user', (done) => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    ...
    .expect(200)
    .expect((res) => {
      expect(res.body.todo.text).toBe('Updated second todo');
